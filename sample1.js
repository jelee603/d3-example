var Table = function module() {
    ...
    function exports(selection) {
        selection.each(function (dataset) {
            ...
            // SVG
            var scrollDiv = d3.select('#div-scroll')
                .append('svg')
                .attr('height', '100%')
            ...
            var tableBodySvg = visSvg.append('g').attr('class', 'table-group');
            var tableHeaderSvg = visSvg.append('g').attr('class', 'table-group');
                ...
                .each(function(pD, pI){
                    ...
                    cell.enter().append("rect")
                        .attr({
                            ...
                            width: 5,
                            height: 35,
                            x: function(d, i){return i * cellW + (cellW * rowHeaderLevelNum) + d},
                            y: function(d, i){return pI * cellH + cellH + 5 },
                        })
                        .style({fill:'pink'})
                    // Text
